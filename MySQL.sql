DROP DATABASE IF EXISTS cadastro_todo_dia;
...
CREATE TABLE cadastro_de_fornecedores (
  ...
  Ramo_de_atuacao VARCHAR(100) NOT NULL
);
...
INSERT INTO cadastrar_clientes (ID_Cliente, Nome_Cliente, Endereco_Cliente, Telefone_Cliente, Email_Cliente, CPF_Cliente) 
VALUES
...
INSERT INTO cadastro_de_fornecedores (ID_Fornecedor, Nome_Fornecedor, Email_Fornecedor, Telefone_Fornecedor, Endereco_Fornecedor, Rua_Fornecedor, Bairro_Fornecedor, Estado_Fornecedor, CEP_Fornecedor, CNPJ_Fornecedor, Historico_de_fornecimento, Ramo_de_atuacao) 
VALUES
...
INSERT INTO caixa (ID_Caixa, Cliente, Produto, Forma_de_pagamento, Quantidade_Vendida, Valor_Final) 
VALUES
(1, 1, 1, 'Crédito', 2,  25.80),
(2, 2, 3, 'Dinheiro', 1, 13.50),
(3, 3, 2, 'Débito', 3, 25.00),
(4, 4, 4, 'Pix', 5, 6.00),
(5, 5, 5, 'Crédito', 2, 9.90);
